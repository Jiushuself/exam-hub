---
title: "方阵问题"
description: "整理考公数量关系中的“方阵问题”知识点，覆盖一、含义、二、实心方阵、三、空心方阵、四、长方阵等内容，适合系统复习、专项训练、考前回顾与查漏补缺。"
---
...
<span class="gongkao-missing-image" role="note">图片暂不可用</span>
...
3. 方阵层数为：当n为偶数时，层数=n2；当n为奇数时，层数=n+12
...
<details class="details custom-block" open="" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="5" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">根据方阵公式：<mark>每层总数=（该层每边个数-1）×4</mark>，可知由外到内第三层每边的学生数=（76÷4）+1=20人，相邻两层每边数相差2，因此最外层的每边的学生数=20+2+2=24，所以该方阵共有学生24×24=576，故正确答案为C。</li></ol></details>
...
<details class="details custom-block" open="" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="5" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">根据方阵公式某层总数=（该层每边个数 - 1）×4，根据题意最外层人数是128人，即128=（方阵最外层每边人数-1）×4，方阵最外层每边人数=（128÷4）+1=33人，则33排33列的方阵总人数=33×33=1089人。故正确答案为C。</li></ol></details>
...
<details class="details custom-block" open="" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="5" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">已知为长宽相等的方阵问题。设<mark>新方阵最外层每边为n，得知鲜花方阵为新方阵最外围</mark>，根据某层总数=（该层每边个数-1）×4公式，则鲜花方阵的总数为(n-1)×4=4n-4。又因为<mark>相邻两层每边数相差2</mark>，合成后的彩旗方阵每边数为n-2。则彩旗方阵总数为(n-2)²=n²-4n+4。已知彩旗方阵比鲜花方阵多28人，n²-4n+4-(4n-4)=28，解得n=10。故新方阵的总数=10²=100。选A。</li></ol></details>
