---
title: "01 位置规律"
description: "整理考公判断推理中的“01 位置规律”知识点，覆盖一、平移、1、移动方向、2、移动步数、二、旋转、翻转等内容，适合系统复习、专项训练、考前回顾与查漏补缺。"
---
...
### 1、移动方向
 ...
 （2）**绕圈移动**：顺时针、逆时针
 （3）**元素位置互换**
 ![img](/gongkao-assets/remote/351002d81812743ddbd2.png)
...
![img](/gongkao-assets/remote/068dfd6fafd8b55eddc2.png)
...
### 1、旋转
 ...
 ![img](/gongkao-assets/remote/50d3ee552e7e1e093eb2.png)
 （1）**旋转方向**：顺时针、逆时针
...
### 2、翻转
 ...
 ![img](/gongkao-assets/remote/bd60c716824c37e73ebf.png)
 （1）**左右翻**：以竖轴为轴进行翻转
 （2）**上下翻**：以横轴为轴进行翻转

:::info （2019广东）下列选项中最符合所给图形规律的是（ ）。

 ![img](/gongkao-assets/remote/0d4a17a10ec95462c661.png)
...
:::info **例1**：(2024年青海)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性。
 ...
 ![img](/gongkao-assets/remote/21ec0d2124da9703c4d5.png)

<details class="details custom-block" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="2" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">元素组成相同，优先考虑<mark>位置规律</mark>。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">观察发现，题干图形<mark>内圈和外圈的黑球数量均相同，优先内外分开看</mark>。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">如下图所示，标记为①的黑球在内圈每次逆时针移动一格，标记为②③的黑球在外圈每次顺时针移动三格，只有C项符合规律。故正确答案为C。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;"><img src="/gongkao-assets/remote/8e22f503fb3f450483c6.png" alt="" style="box-sizing: border-box; display: block; max-width: 100%; height: auto;"></li></ol></details>

:::

:::info **例2**：(2020年湖南)从所给四个选项中，选择最合适的一项填入问号处，使之呈现一定的规律性。

 ![img](/gongkao-assets/remote/a69bb2c25549baae1b5b.png)

<details class="details custom-block"  style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="2" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">本题为九宫格题。元素组成相同，优先考虑位置规律。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;"><mark>九宫格优先看横行</mark>，第一行图1旋转得到图2，图2左右翻转得到图3，第二行验证符合此规律。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">第三行应用此规律，图1旋转得到图2，故？处图形由图2左右翻转得到，只有B项符合。</li></ol></details>

:::

:::info **例3**：(2022年江苏)请从所给的四个选项中，选出最恰当的一项填入问号处，使之呈现一定的规律性。

 ![img](/gongkao-assets/remote/d236a0b3cf71f02188e1.png)

<details class="details custom-block"  style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">元素组成相同，优先考虑位置规律。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;"><mark>九宫格优先横向看</mark>，第一行中，图一逆时针旋转得到图二，图二上下翻转得到图三；</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">第二行经验证，符合该规律；第三行应用规律，只有B项符合。</li></ol></details>

:::

:::info **例4**：(2018年山东)从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：

 ![img](/gongkao-assets/remote/413cc6e4dec0e1b609f1.png)
...
:::info **例5**：(2018深圳)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/339cf3761708ed3d1113.png)
...
:::info **例6**：(2021海南)以下哪项不是由左图得到的？
 ...
 ![img](/gongkao-assets/remote/6751dbb68d6d6855cdee.png)
...
:::info **例7**：(2023甘肃)从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定规律性：
 ...
 ![img](/gongkao-assets/remote/82e0dd005840d3bd8ce4.png)
...
:::info **例8**：(2014年广州)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/642a2ba6f8667c0b8a9a.png)
