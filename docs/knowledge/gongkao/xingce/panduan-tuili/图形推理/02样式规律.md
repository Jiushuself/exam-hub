---
title: "02 样式规律"
description: "整理考公判断推理中的“02 样式规律”知识点，覆盖一、遍历、二、加减、同异、1、相加、相减、2、去同存异等内容，适合系统复习、专项训练、考前回顾与查漏补缺。"
---
...
![img](/gongkao-assets/remote/aa1d8f6fb85367342b2b.png)
...
### 1、相加、相减
 ...
 （2）相减：减去相同的元素。
 ![img](/gongkao-assets/remote/33c54230adac33b0d1c2.png)

### 2、去同存异

 （1）**去除图形中相同的元素，保留不同的元素。**
 ![img](/gongkao-assets/remote/b01d9b7bb0d32f4b6a21.png)

### 3、去异存同

 （1）**去除图形中不相同的元素，保留相同的元素。**
![img](/gongkao-assets/remote/4d64343357abe8b748a0.png)
...
（2021上海）从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/eeab93c9b8bb77ab309a.png)
...
![img](/gongkao-assets/remote/2d2870ab02b618193c07.png)
...
![img](/gongkao-assets/remote/be07cbe8ed7e0f1bc1c6.jpg)
...
**例2**：(2023重庆选调)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/0d545b3332e360eb9d0d.png)
...
![img](/gongkao-assets/remote/16d8b49d10759227b7d8.png)

<details class="details custom-block" style="box-sizing: border-box; border: 1px solid rgba(0, 0, 0, 0); border-radius: 8px; padding: 16px 16px 8px; line-height: 24px; font-size: 16px; color: rgb(60, 60, 67); background-color: rgba(142, 150, 170, 0.14); margin: 0px !important;"><summary style="box-sizing: border-box; touch-action: manipulation; margin: 0px 0px 8px; font-weight: 700; cursor: pointer; user-select: none;">解析</summary><ol start="2" style="box-sizing: border-box; list-style: decimal; margin: 16px 0px; padding: 0px 0px 0px 1.25rem;"><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none;">图形元素组成相似，考虑样式规律。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;"><mark>在前一组图形中，第一个图形减去第二个图形得到第三个图形</mark>，后一组应该满足同样的规律。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">因为选项中都有圆形的外框，所以我们只需要考虑内部线条的关系，第一个图形减去第二个图形符合条件的只有D项。</li><li style="box-sizing: border-box; overflow-wrap: break-word; list-style: none; margin-top: 8px;">故正确答案为D。</li></ol></details>
...
**例5**：(2020天津)从所给四个选项中，选择最合适的一项填入问号处，使之呈现一定的规律性。
 ...
 ![img](/gongkao-assets/remote/17e3d6c2ee08babdbb66.png)
...
**例6**：(2021国家)从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/1410763783b0226c95ec.png)
...
**例7**：(2019青海法院、检察院)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定规律性。
 ...
 ![img](/gongkao-assets/remote/139a2f3f4bf6c0fbbcf7.png)
...
**例8**：(2013广东)从所给的四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/bb70c8b75a185cc60389.png)
...
**例9**：(2012联考)从所给四个选项中，选择最合适的一个填入问号处，使之呈现一定的规律性：
 ...
 ![img](/gongkao-assets/remote/20d373922149abc82791.png)
...
**例10**：(2020年上海)下列选项中，与其他三个图形规律不同的是：
 ...
 ![img](/gongkao-assets/remote/465b8afd6aef409b9c3e.png)
...
==== ![img](/gongkao-assets/remote/41b7f086f5132c01fd02.png)
