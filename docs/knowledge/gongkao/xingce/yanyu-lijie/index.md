---
title: "言语理解"
description: "整理考公言语理解中的“言语理解知识总览”知识点，覆盖什么是言语理解与表达？、如何学习？、扎实基础知识、掌握各类题型技巧等内容，适合系统复习、专项训练、考前回顾与查漏补缺。"
---
...
- [标题填入](./标题填入)
- [病句辨析](./病句辨析)
- **逻辑填空**：[词义辨析](./逻辑填空/词义辨析) · [词语辨析](./逻辑填空/词语辨析) · [语境分析](./逻辑填空/语境分析) · [词句理解](./逻辑填空/词句理解) · [词语积累](./逻辑填空/词语积累)
- [歧义句辨析](./歧义句辨析)
- [推断下文](./推断下文)
- [细节判断](./细节判断)
- [篇章阅读](./篇章阅读)
- [语句排序](./语句排序)
- [语句填空](./语句填空)
- **中心理解**：[并列关系](./中心理解/并列关系) · [递进关系](./中心理解/递进关系) · [反面论证](./中心理解/反面论证) · [条件关系](./中心理解/条件关系) · [行文脉络](./中心理解/行文脉络) · [因果关系](./中心理解/因果关系) · [转折关系](./中心理解/转折关系)
