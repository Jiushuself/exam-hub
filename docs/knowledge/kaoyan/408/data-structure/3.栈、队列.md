---
title: '3.栈、队列'
description: '计算机 408 数据结构「3.栈、队列」知识笔记，涵盖逻辑结构、术语、物理（存储）结构、基本操作等内容，适合系统复习、章节回顾与查漏补缺。'
---

# 栈和队列

![在这里插入图片描述](/kaoyan-408-data-structure-assets/ec0021263be8ceeb8420.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/fdd215d97a506b96be2c.png)

**特点**：**后进先出（last in first out, LIFO）**

**<mark>逻辑结构</mark>**：与普通线性表**相同**。<mark>栈&队列的**逻辑结构**相同</mark>。
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/709a3f8eb47bac1b2ebc.png)
...
- 类型指针指针变量名 = new 类型
- 类型指针指针变量名 = new 类型(初始值)
- 类型指针指针变量名 = new 类型[元素个数]
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/2de7442ba6b34b94f20f.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/64ed36afcbe0c7a09640.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/306b09339a584e9bdce3.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/f3f321c0fe202efcfbf3.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/0c06efa88b19d84e25d0.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/d04e305fef90b4eee57c.png)
...
1. 判空：`Q.rear == Q.front`.
1. 判满：`(Q.rear + 1)%MaxSize == Q.front`. 队尾+1
1. 入队：`Q.rear = (Q.rear+1)%MaxSize`.
1. 出队：`Q.front = (Q.front+1)%MaxSize`.
1. 长度：`(Q.rear + MaxSize - Q.front)%MaxSize`.
...
![3队列判满](/kaoyan-408-data-structure-assets/feacb3fd372982c80c27.png)
...
![3队列溢出](/kaoyan-408-data-structure-assets/3a681a4fa4128c950250.png)
...
![3链队列](/kaoyan-408-data-structure-assets/65a4a3b398488bbf8e19.png)

### 2.1初始化（带头结点）

![在这里插入图片描述](/kaoyan-408-data-structure-assets/a9adfe50051347ee0798.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/35afe34965bf5482f462.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/c395457f1e2dfdb54b0e.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/d6eee7059700bf94552c.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/f53b32a3f60ef3031602.png)

**输入受限的双端队列**：只允许从**一端插入、两端删除**的线性表。

![在这里插入图片描述](/kaoyan-408-data-structure-assets/fe9eb951cc665c430a3f.png)

**输出受限的双端队列**：只允许从**两端插入、一端删除**的线性表。

![在这里插入图片描述](/kaoyan-408-data-structure-assets/2e8f83df6c36635175a8.png)

### <mark>【考点】输出序列合法性</mark>
...
![3栈括号匹配](/kaoyan-408-data-structure-assets/c472a342daa7b4b35b18.png)

### 1.1三种错误情况

匹配失败：

![3栈括号匹配-匹配失败](/kaoyan-408-data-structure-assets/a96db541d66508727610.png)
...
![3栈括号匹配-非空](/kaoyan-408-data-structure-assets/01e7e3d2cf2f54240f36.png)
...
![3栈括号匹配-流程图](/kaoyan-408-data-structure-assets/eadcb94dc41fcf1a71ab.png)
...
![3后缀表达式](/kaoyan-408-data-structure-assets/b343156bdd2f8cef691b.png)
...
![后缀表达式计算](/kaoyan-408-data-structure-assets/d4f59312ea69c844a58f.png)

#### ❗2.3.2<mark>【考点】机算</mark>
...
![后缀表达式计算](/kaoyan-408-data-structure-assets/14b936a78a2491d42bb2.gif)
...
![img](/kaoyan-408-data-structure-assets/b8c3e416210750e7b995.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/a31a366744537bbe0a64.png)
...
![层次遍历](/kaoyan-408-data-structure-assets/5290ca9a95f2f427562b.png)
