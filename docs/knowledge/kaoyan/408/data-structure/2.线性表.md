---
title: '2.线性表'
description: '计算机 408 数据结构「2.线性表」知识笔记，涵盖1.逻辑结构、2.物理（存储）结构、3.基本操作、0.特点等内容，适合系统复习、章节回顾与查漏补缺。'
---

# 线性表linear list

![linear list](/kaoyan-408-data-structure-assets/776aaac204d704fb26bb.png)
...
- a1是**表头元素**；an是**表尾元素**。
- 线性表中的位序是**<mark>从 1 开始</mark>的**，而**数组**中元素的下标是**从 0开始**的。
...
2. 链表（链式存储）
   ...
   【注意】链式存储，结点内的**<mark>存储单元地址</mark>是一定连续的**，但是<mark>存储空间</mark>不一定连续。
...
那么，第二个元素就是 LOC(L)+数据元素的大小；第三个元素就是 LOC(L)+数据元素的大小*2
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/b5a3bdf8086dbfd03a44.png)

<mark>【注意】</mark>头结点 L 不能轻易`L=L->next`，如果重新赋值，那么此时的 L 就不是头结点了，因为已经后移了。
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/1026db2a275b1620d55f.png)
...
![2单链表位序插入](/kaoyan-408-data-structure-assets/2efa7a7609c73932f641.png)
...
![2按位查找](/kaoyan-408-data-structure-assets/14b86bb2a980c24322d8.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/61a9b47aadf3d2e135a8.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/cc4df1716658728559a7.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/a06ed25ccd3685f62738.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/28ebe63092fbaa81d518.png)

**循环单链表**（Circular Singly Linked List）是一种特殊类型的单链表，其中最后一个节点的指针指向头节点，形成一个循环。

![在这里插入图片描述](/kaoyan-408-data-structure-assets/559c974446cb03362f79.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/008fb4189663a43e27df.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/5e0a3eeee427ec6e06a3.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/540afbbd152a150d8dc0.png)

# 五、静态链表

**静态链表**是使用数组来模拟链表结构的一种数据结构，**用<mark>数组</mark>的方式实现的链表**。
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/7619bebe28c90874e3c5.png)
...
![在这里插入图片描述](/kaoyan-408-data-structure-assets/2223bef1871669a914b3.png)
...
![2顺序表](/kaoyan-408-data-structure-assets/f941b7daa4fb47b1706c.png)
...
![2链表](/kaoyan-408-data-structure-assets/acd879780d838d488017.png)
